...
ShareMate a un système de notifications à deux canaux, **découplé** des fonctionnalités qui les
...
`Push désactivé (VAPID_* absents) : seul le centre in-app est actif.`
